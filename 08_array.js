...
console.log(`====== slice() =========`);
const arraySliced = arrayNumber1.slice(3);
console.log(arraySliced);

const arrayElements = arrayNumber1.slice(1, 4);
...
var arrayNumber = [22, 11, 44, 55, 77,];
//Insert element 99 at index 2 ==> [2,11,99,44,55,77
arrayNumber.splice(2, 0, 99);
console.log(arrayNumber);

console.log(`Insert elements 100,200,400 at index 3 and at the time of insertion don't replace.`);
var arrayNumber = [22, 11, 44, 55, 77, 33];
