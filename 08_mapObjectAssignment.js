...
bankMap.set(12457954,sbi_bank);
bankMap.set(458958962,icici_bank);
bankMap.set(598215663,kotak_bank);
bankMap.set(556456789,hdfc_bank);
bankMap.set(864795216,panjab_bank);
