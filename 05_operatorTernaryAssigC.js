...
function maleMarriageEligibility(gender, age, boyName){
    ...
    var result = stringGender=='male' && numAge>=21 ? console.log(`Hey "${boyName}" you are eligible for Marriage.`):console.log(`Sorry "${boyName}" but you are not Eligible for Marriage.\n`);
    return result;
}
...
function femaleMarriageEligibility(gender, age, girlName){
    ...
    // console.log(`after ${typeof numAge}`);
    // console.log(stringGender);
    var result = stringGender=='female' && numAge>=18 ? console.log(`Hey "${girlName}" you are eligible for Marriage.`):console.log(`Sorry "${girlName}" but you are not Eligible for Marriage.`);
    return result;
}
